...
public final class VideoMode {
   ...
   public boolean equals(final Object o) {
      if (this == o) {
         ...
         com.mojang.blaze3d.platform.VideoMode videoMode = (com.mojang.blaze3d.platform.VideoMode)o;
   ...
   public static Optional<com.mojang.blaze3d.platform.VideoMode> read(@Nullable final String s) {
      if (s == null) {
         ...
         try {
            ...
            if (m.matches()) {
               ...
               return Optional.of(new com.mojang.blaze3d.platform.VideoMode(width, height, componentBits, componentBits, componentBits, rate));
            }
