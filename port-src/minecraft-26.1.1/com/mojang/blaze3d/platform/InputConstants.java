...
public class InputConstants {
   ...
   public static final com.mojang.blaze3d.platform.InputConstants.Key UNKNOWN = com.mojang.blaze3d.platform.InputConstants.Type.KEYSYM.getOrCreate(-1);

   public static com.mojang.blaze3d.platform.InputConstants.Key getKey(final KeyEvent event) {
      return event.key() == -1
         ? com.mojang.blaze3d.platform.InputConstants.Type.SCANCODE.getOrCreate(event.scancode())
         : com.mojang.blaze3d.platform.InputConstants.Type.KEYSYM.getOrCreate(event.key());
   }

   public static com.mojang.blaze3d.platform.InputConstants.Key getKey(final String name) {
      if (com.mojang.blaze3d.platform.InputConstants.Key.NAME_MAP.containsKey(name)) {
         return com.mojang.blaze3d.platform.InputConstants.Key.NAME_MAP.get(name);
      } else {
   ...
   public static boolean isKeyDown(final com.mojang.blaze3d.platform.Window window, final int key) {
      return GLFW.glfwGetKey(window.handle(), key) == 1;
   }

   public static void setupKeyboardCallbacks(
      final com.mojang.blaze3d.platform.Window window,
   ...
   public static void grabOrReleaseMouse(final com.mojang.blaze3d.platform.Window window, final int cursorMode, final double xpos, final double ypos) {
   ...
   public static void updateRawMouseInput(final com.mojang.blaze3d.platform.Window window, final boolean value) {
      if (isRawMouseInputSupported()) {
         GLFW.glfwSetInputMode(window.handle(), 208901, com.mojang.blaze3d.platform.GLX.glfwBool(value));
      }
   }

   public static final class Key {
      private final String name;
      private final com.mojang.blaze3d.platform.InputConstants.Type type;
      private final int value;
      private final Supplier<Component> displayName;
      private static final Map<String, com.mojang.blaze3d.platform.InputConstants.Key> NAME_MAP = Maps.newHashMap();

      private Key(final String name, final com.mojang.blaze3d.platform.InputConstants.Type type, final int value) {
         this.name = name;
         this.type = type;
         this.value = value;
      ...
      public boolean equals(final Object o) {
         if (this == o) {
            ...
            com.mojang.blaze3d.platform.InputConstants.Key key = (com.mojang.blaze3d.platform.InputConstants.Key)o;
   ...
   public static enum Type {
      ...
      MOUSE(
         "key.mouse",
         (value, name) -> Language.getInstance().has(name) ? Component.translatable(name) : Component.translatable("key.mouse", new Object[]{value + 1})
      );

      private static final String KEY_KEYBOARD_UNKNOWN = "key.keyboard.unknown";
      private final Int2ObjectMap<com.mojang.blaze3d.platform.InputConstants.Key> map = new Int2ObjectOpenHashMap();
      private final String defaultPrefix;
      private final BiFunction<Integer, String, Component> displayTextSupplier;

      private static void addKey(final com.mojang.blaze3d.platform.InputConstants.Type type, final String name, final int value) {
         com.mojang.blaze3d.platform.InputConstants.Key key = new com.mojang.blaze3d.platform.InputConstants.Key(name, type, value);
      ...
      public com.mojang.blaze3d.platform.InputConstants.Key getOrCreate(final int value) {
         return (com.mojang.blaze3d.platform.InputConstants.Key)this.map.computeIfAbsent(value, intValue -> {
            ...
            return new com.mojang.blaze3d.platform.InputConstants.Key(name, this, intValue);
         });
      }
