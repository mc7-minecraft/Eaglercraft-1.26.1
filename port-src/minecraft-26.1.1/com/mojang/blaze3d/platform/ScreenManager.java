...
public class ScreenManager {
   ...
   private final Long2ObjectMap<com.mojang.blaze3d.platform.Monitor> monitors = new Long2ObjectOpenHashMap();
   private final com.mojang.blaze3d.platform.MonitorCreator monitorCreator;

   public ScreenManager(final com.mojang.blaze3d.platform.MonitorCreator monitorCreator) {
   ...
   @Nullable
   public com.mojang.blaze3d.platform.Monitor getMonitor(final long monitor) {
      return (com.mojang.blaze3d.platform.Monitor)this.monitors.get(monitor);
   }

   @Nullable
   public com.mojang.blaze3d.platform.Monitor findBestMonitor(final com.mojang.blaze3d.platform.Window window) {
      ...
      if (windowMonitor != 0L) {
         ...
         int maxArea = -1;
         com.mojang.blaze3d.platform.Monitor result = null;
         ...
         while (var12.hasNext()) {
            com.mojang.blaze3d.platform.Monitor monitor = (com.mojang.blaze3d.platform.Monitor)var12.next();
