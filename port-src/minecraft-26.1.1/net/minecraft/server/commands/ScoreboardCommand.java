...
public class ScoreboardCommand {
   ...
   private static int setScoreDisplay(
      final CommandSourceStack source, final Collection<ScoreHolder> names, final Objective objective, @Nullable final Component display
   ) {
      Scoreboard scoreboard = source.getServer().getScoreboard();
   ...
   private static int setScoreNumberFormat(
      final CommandSourceStack source, final Collection<ScoreHolder> names, final Objective objective, @Nullable final NumberFormat numberFormat
   ) {
      Scoreboard scoreboard = source.getServer().getScoreboard();
