...
public class ScreenEffectRenderer {
   ...
   private void renderItemActivationAnimation(final PoseStack poseStack, final float partialTicks, final SubmitNodeCollector submitNodeCollector) {
      if (this.itemActivationItem != null && this.itemActivationTicks > 0) {
         ...
         poseStack.mulPose(Axis.YP.rotationDegrees(900.0F * Mth.abs(Mth.sin((double)piScale))));
         poseStack.mulPose(Axis.XP.rotationDegrees(6.0F * Mth.cos((double)(scale * 8.0F))));
         poseStack.mulPose(Axis.ZP.rotationDegrees(6.0F * Mth.cos((double)(scale * 8.0F))));
