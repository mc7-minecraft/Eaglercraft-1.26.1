               ...
               this.nameTagSubmitsNormal
                  .add(
                     new SubmitNodeStorage.NameTagSubmit(
                        pose, x, (float)offset, name, LightCoordsUtil.lightCoordsWithEmission(lightCoords, 2), -1, 0, distanceToCameraSq
                     )
                  );
               this.nameTagSubmitsSeethrough
                  .add(new SubmitNodeStorage.NameTagSubmit(pose, x, (float)offset, name, lightCoords, -2130706433, backgroundColor, distanceToCameraSq));
            } else {
               this.nameTagSubmitsNormal
                  .add(new SubmitNodeStorage.NameTagSubmit(pose, x, (float)offset, name, lightCoords, -2130706433, backgroundColor, distanceToCameraSq));
            }
