   ...
   public void performRangedAttack(final LivingEntity target, final float power) {
      ...
      if (this.level() instanceof ServerLevel serverLevel) {
         Projectile.spawnProjectileUsingShoot(
            trident, serverLevel, tridentItemStack, xd, yd + distanceToTarget * 0.2F, zd, 1.6F, (float)(14 - this.level().getDifficulty().getId() * 4)
         );
      }
   ...
   private static class DrownedMoveControl extends MoveControl {
      ...
      public void tick() {
         ...
         if (this.drowned.wantsToSwim() && this.drowned.isInWater()) {
            ...
            this.drowned
               .setDeltaMovement(this.drowned.getDeltaMovement().add((double)newSpeed * xd * 0.005, (double)newSpeed * yd * 0.1, (double)newSpeed * zd * 0.005));
         } else {
