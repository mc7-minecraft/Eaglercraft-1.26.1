...
public class SpiderModel extends EntityModel<LivingEntityRenderState> {
   ...
   public void setupAnim(final LivingEntityRenderState state) {
      ...
      float swingMiddleFront = -(Mth.cos((double)(animationPos * 2.0F + (float) (Math.PI / 2))) * 0.4F) * animationSpeed;
      float swingFront = -(Mth.cos((double)(animationPos * 2.0F + (float) (Math.PI * 3.0 / 2.0))) * 0.4F) * animationSpeed;
      ...
      float stepMiddleFrontHind = Math.abs(Mth.sin((double)(animationPos + (float) (Math.PI / 2))) * 0.4F) * animationSpeed;
      float stepFront = Math.abs(Mth.sin((double)(animationPos + (float) (Math.PI * 3.0 / 2.0))) * 0.4F) * animationSpeed;
