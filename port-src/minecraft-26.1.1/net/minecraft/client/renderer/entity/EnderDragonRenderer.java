...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon, EnderDragonRenderState> {
   ...
   public static void submitCrystalBeams(
      ...
      poseStack.mulPose(Axis.YP.rotation((float)(-Math.atan2((double)deltaZ, (double)deltaX)) - (float) (Math.PI / 2)));
      poseStack.mulPose(Axis.XP.rotation((float)(-Math.atan2((double)horizontalLength, (double)deltaY)) - (float) (Math.PI / 2)));
