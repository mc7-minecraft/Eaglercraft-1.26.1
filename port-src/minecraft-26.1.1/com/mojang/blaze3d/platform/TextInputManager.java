...
public class TextInputManager {
   ...
   public TextInputManager(final com.mojang.blaze3d.platform.Window window) {
      this.window = window;
   }
   ...
   private void setIMEInputMode(final boolean value) {
      GLFW.glfwSetInputMode(this.window.handle(), 208903, com.mojang.blaze3d.platform.GLX.glfwBool(value));
   }
}
