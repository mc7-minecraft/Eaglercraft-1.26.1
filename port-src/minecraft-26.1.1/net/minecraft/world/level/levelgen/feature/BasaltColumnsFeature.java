...
public class BasaltColumnsFeature extends Feature<ColumnFeatureConfiguration> {
   ...
   @Nullable
   private static BlockPos findSurface(final LevelAccessor level, final int lavaSeaLevel, final BlockPos.MutableBlockPos cursor, int limit) {
   ...
   @Nullable
   private static BlockPos findAir(final LevelAccessor level, final BlockPos.MutableBlockPos cursor, int limit) {
