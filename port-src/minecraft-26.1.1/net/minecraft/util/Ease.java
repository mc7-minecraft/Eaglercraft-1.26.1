...
public class Ease {
   ...
   public static float inElastic(final float x) {
      if (x == 0.0F) {
         ...
         return (float)(-Math.pow(2.0, 10.0 * (double)x - 10.0) * Math.sin(((double)x * 10.0 - 10.75) * (float) (Math.PI * 2.0 / 3.0)));
      }
   }
   ...
   public static float inSine(final float x) {
      return 1.0F - Mth.cos((double)(x * (float) (Math.PI / 2)));
   }
   ...
   public static float inOutCirc(final float x) {
      return x < 0.5F
         ? (float)((1.0 - Math.sqrt(1.0 - Math.pow(2.0 * (double)x, 2.0))) / 2.0)
         : (float)((Math.sqrt(1.0 - Math.pow(-2.0 * (double)x + 2.0, 2.0)) + 1.0) / 2.0);
   }
   ...
   public static float outElastic(final float x) {
      ...
      if (x == 0.0F) {
         ...
         return x == 1.0F ? 1.0F : (float)(Math.pow(2.0, -10.0 * (double)x) * Math.sin(((double)x * 10.0 - 0.75) * (float) (Math.PI * 2.0 / 3.0)) + 1.0);
      }
   }
   ...
   public static float outSine(final float x) {
      return Mth.sin((double)(x * (float) (Math.PI / 2)));
   }
   ...
   public static float inOutElastic(final float x) {
      ...
      if (x == 0.0F) {
         ...
         double sin = Math.sin((20.0 * (double)x - 11.125) * (float) Math.PI * 4.0F / 9.0F);
