...
public abstract class DirectStateAccess {
   public static DirectStateAccess create(
      final GLCapabilities capabilities, final Set<String> enabledExtensions, final com.mojang.blaze3d.GraphicsWorkarounds workarounds
   ) {
