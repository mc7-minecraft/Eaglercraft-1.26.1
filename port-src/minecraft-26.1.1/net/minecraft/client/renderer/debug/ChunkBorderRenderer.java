   ...
   public void emitGizmos(
      ...
      for (int x = -16; x <= 32; x += 16) {
         for (int z = -16; z <= 32; z += 16) {
            Gizmos.line(
               new Vec3(xstart + (double)x, (double)ymin, zstart + (double)z),
               new Vec3(xstart + (double)x, (double)ymax, zstart + (double)z),
      ...
      Gizmos.cuboid(
            new AABB(
               (double)cameraPos.minBlockX(),
               (double)cameraPos.minBlockY(),
               (double)cameraPos.minBlockZ(),
               (double)(cameraPos.maxBlockX() + 1),
               (double)(cameraPos.maxBlockY() + 1),
               (double)(cameraPos.maxBlockZ() + 1)
            ),
