...
public interface CommandEncoderBackend {
   ...
   MappedView mapBuffer(GpuBufferSlice buffer, boolean read, boolean write);
   ...
   void writeToTexture(GpuTexture destination, ByteBuffer source, Format format, int mipLevel, int depthOrLayer, int destX, int destY, int width, int height);
