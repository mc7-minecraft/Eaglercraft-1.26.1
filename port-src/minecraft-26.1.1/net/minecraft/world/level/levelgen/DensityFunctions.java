...
public final class DensityFunctions {
      ...
      private static float getHeightValue(final SimplexNoise islandNoise, final int sectionX, final int sectionZ) {
         ...
         for (int xo = -12; xo <= 12; xo++) {
            for (int zo = -12; zo <= 12; zo++) {
               ...
               if (totalChunkX * totalChunkX + totalChunkZ * totalChunkZ > 4096L && islandNoise.getValue((double)totalChunkX, (double)totalChunkZ) < -0.9F) {
   ...
   private static record MulOrAdd(DensityFunctions.MulOrAdd.Type specificType, DensityFunction input, double minValue, double maxValue, double argument)
      implements DensityFunctions.TwoArgumentSimpleFunction,
   ...
   private static record RangeChoice(
