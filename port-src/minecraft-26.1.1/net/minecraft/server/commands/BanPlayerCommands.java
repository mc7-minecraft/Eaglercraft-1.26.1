...
public class BanPlayerCommands {
   ...
   private static int banPlayers(final CommandSourceStack source, final Collection<NameAndId> players, @Nullable final Component reason) throws CommandSyntaxException {
