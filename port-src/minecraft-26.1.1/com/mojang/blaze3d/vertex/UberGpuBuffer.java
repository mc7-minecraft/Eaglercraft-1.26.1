...
public class UberGpuBuffer<T> implements AutoCloseable {
   ...
   public UberGpuBuffer(
      ...
      final com.mojang.blaze3d.GraphicsWorkarounds workarounds
   ) {
      if (stagingBufferSize > heapSize) {
         ...
         UberGpuBuffer.UberGpuBufferHeap initialHeap = new UberGpuBuffer.UberGpuBufferHeap((long)heapSize, gpuDevice, usage, initialHeapName);
   ...
   private abstract static class UberGpuBufferStagingBuffer {
      public static UberGpuBuffer.UberGpuBufferStagingBuffer create(
         final String name, final GpuDevice gpuDevice, final int stagingBufferSize, final com.mojang.blaze3d.GraphicsWorkarounds workarounds
      ) {
