...
public class VillagerTrades {
   ...
   public static Holder<VillagerTrade> bootstrap(final BootstrapContext<VillagerTrade> context) {
      ...
      for (Pair<ResourceKey<VillagerTrade>, Item> pair : List.of(
         ...
         context.register(
            (ResourceKey<VillagerTrade>)pair.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate((Item)pair.getRight(), 8), 4, 1, 0.05F, Optional.empty(), List.of())
         );
      }
      ...
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         context.register(
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate((Item)entry.getRight()), 8, 1, 0.05F, Optional.empty(), List.of())
         );
      }
   ...
   private static void registerWanderingTraderFlowers(final BootstrapContext<VillagerTrade> context) {
      ...
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         context.register(
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate((Item)entry.getRight()), 12, 1, 0.05F, Optional.empty(), List.of())
         );
      }
   ...
   private static void registerWanderingTraderSaplings(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         context.register(
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 5), new ItemStackTemplate((Item)entry.getRight()), 8, 1, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerWanderingTraderDyes(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         context.register(
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate((Item)entry.getRight(), 3), 12, 1, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerMasonLevelFourTerracotta(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> block : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)block.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate((Item)block.getRight()), 12, 15, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerMasonLevelThreeBlocks(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> block : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)block.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate((Item)block.getRight(), 4), 16, 10, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerMasonLevelThreeStones(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> stone : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)stone.getLeft(),
            new VillagerTrade(new TradeCost((ItemLike)stone.getRight(), 16), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerBoatTrades(final BootstrapContext<VillagerTrade> context, final HolderGetter<VillagerType> villagerVariants) {
      for (ImmutableTriple<ResourceKey<VillagerTrade>, Item, List<ResourceKey<VillagerType>>> entry : List.of(
         ...
         ResourceKey<VillagerTrade> resouceKey = (ResourceKey<VillagerTrade>)entry.left;
         ...
         register(
            ...
            new VillagerTrade(
               ...
               30,
               0.05F,
               villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, (List<ResourceKey<VillagerType>>)entry.right)),
               List.of()
            )
         );
      }
   ...
   private static void registerWoolSales(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost((ItemLike)entry.getRight(), 18), new ItemStackTemplate(Items.EMERALD), 16, 2, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerLevelTwoDyeTrades(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost((ItemLike)entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 10, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerLevelThreeDyeTrades(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost((ItemLike)entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 20, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerLevelFourDyeTrades(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost((ItemLike)entry.getRight(), 12), new ItemStackTemplate(Items.EMERALD), 16, 30, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerWoolPurchases(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate((Item)entry.getRight()), 16, 5, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerCarpetPurchases(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 1), new ItemStackTemplate((Item)entry.getRight(), 4), 16, 5, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerBedTrades(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate((Item)entry.getRight()), 12, 10, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerShepherdBannerTrades(final BootstrapContext<VillagerTrade> context) {
      for (Pair<ResourceKey<VillagerTrade>, Item> entry : List.of(
         ...
         register(
            context,
            (ResourceKey<VillagerTrade>)entry.getLeft(),
            new VillagerTrade(new TradeCost(Items.EMERALD, 3), new ItemStackTemplate((Item)entry.getRight()), 12, 15, 0.05F, Optional.empty(), List.of())
         );
      }
   }
   ...
   private static void registerCartographerBannerTrades(final BootstrapContext<VillagerTrade> context, final HolderGetter<VillagerType> villagerVariants) {
      for (Triple<ResourceKey<VillagerTrade>, Item, List<ResourceKey<VillagerType>>> entry : List.of(
         ...
         register(
            ...
            new VillagerTrade(
               new TradeCost(Items.EMERALD, 2),
               new ItemStackTemplate((Item)entry.getMiddle()),
               12,
               15,
               0.05F,
               villagerTypeRestriction(villagerTypeHolderSet(villagerVariants, (List<ResourceKey<VillagerType>>)entry.getRight())),
               List.of()
            )
         );
      }
   ...
   public static List<LootItemFunction> enchantedBook(final HolderGetter<Item> items, final Holder<Enchantment> enchantment, final int level) {
      return List.of(
         new SetEnchantmentsFunction.Builder().withEnchantment(enchantment, ConstantValue.exactly((float)level)).build(),
         FilteredFunction.filtered(
               new ItemPredicate.Builder()
                  .of(items, Items.ENCHANTED_BOOK)
                  .withComponents(
   ...
   private static record VillagerExplorerMapEntry(
