...
public class SubmitNodeStorage implements SubmitNodeCollector {
   ...
   public static record BlockModelSubmit(
   ...
   public static record ItemSubmit(
      PoseStack.Pose pose,
   ...
   public static record ModelPartSubmit(
      PoseStack.Pose pose,
      ModelPart modelPart,
      int lightCoords,
      int overlayCoords,
   ...
   public static record ModelSubmit<S>(
      PoseStack.Pose pose,
      Model<? super S> model,
      S state,
      int lightCoords,
   ...
   public static record NameTagSubmit(
      Matrix4fc pose, float x, float y, Component text, int lightCoords, int color, int backgroundColor, double distanceToCameraSq
   ) {
   }
   ...
   public static record TextSubmit(
      Matrix4fc pose,
      float x,
      float y,
