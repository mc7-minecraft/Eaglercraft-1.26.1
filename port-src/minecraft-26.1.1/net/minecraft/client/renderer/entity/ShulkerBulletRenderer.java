...
public class ShulkerBulletRenderer extends EntityRenderer<ShulkerBullet, ShulkerBulletRenderState> {
   ...
   public void submit(
      ...
      poseStack.mulPose(Axis.YP.rotationDegrees(Mth.sin((double)(tc * 0.1F)) * 180.0F));
      poseStack.mulPose(Axis.XP.rotationDegrees(Mth.cos((double)(tc * 0.1F)) * 180.0F));
      poseStack.mulPose(Axis.ZP.rotationDegrees(Mth.sin((double)(tc * 0.15F)) * 360.0F));
