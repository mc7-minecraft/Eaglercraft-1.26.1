...
public class TradeRebalanceVillagerTrades {
      ...
      for (ImmutableTriple<ResourceKey<VillagerTrade>, ResourceKey<VillagerType>, TagKey<Enchantment>> entry : List.of(
         ...
         VillagerTrades.register(
            ...
            new VillagerTrade(
               ...
               1,
               0.2F,
               VillagerTrades.villagerTypeRestriction(VillagerTrades.villagerTypeHolderSet(villagerVariants, (ResourceKey<VillagerType>)entry.getMiddle())),
               VillagerTrades.enchantedBook(items, enchantments.get((TagKey<Enchantment>)entry.getRight()).map(named1 -> (HolderSet<Enchantment>)named1)),
               doubleTradePrice
            )
         );
      }
      ...
      for (Triple<ResourceKey<VillagerTrade>, ResourceKey<VillagerType>, ResourceKey<Enchantment>> entry : List.of(
         ...
         VillagerTrades.register(
            ...
            new VillagerTrade(
               ...
               0.2F,
               VillagerTrades.villagerTypeRestriction(VillagerTrades.villagerTypeHolderSet(villagerVariants, (ResourceKey<VillagerType>)entry.getMiddle())),
               VillagerTrades.enchantedBook(items, Optional.of(HolderSet.direct(enchantments.getOrThrow((ResourceKey<Enchantment>)entry.getRight())))),
               doubleTradePrice
            )
         );
      }
   ...
   private static record BookTradeDefinition(
