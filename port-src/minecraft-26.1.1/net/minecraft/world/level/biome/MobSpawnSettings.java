...
public class MobSpawnSettings {
   ...
   public static record MobSpawnCost(double energyBudget, double charge) {
      public static final Codec<MobSpawnSettings.MobSpawnCost> CODEC = RecordCodecBuilder.create(
         i -> i.group(
                  Codec.DOUBLE.fieldOf("energy_budget").forGetter((MobSpawnSettings.MobSpawnCost cost) -> cost.energyBudget),
                  Codec.DOUBLE.fieldOf("charge").forGetter((MobSpawnSettings.MobSpawnCost cost) -> cost.charge)
               )
               .apply(i, (energyBudget, charge) -> new MobSpawnSettings.MobSpawnCost(energyBudget, charge))
      );
   }
   ...
   public static record SpawnerData(EntityType<?> type, int minCount, int maxCount) {
      public static final MapCodec<MobSpawnSettings.SpawnerData> CODEC = RecordCodecBuilder.mapCodec(
            i -> i.group(
                     ...
                     ExtraCodecs.POSITIVE_INT.fieldOf("maxCount").forGetter((MobSpawnSettings.SpawnerData data) -> data.maxCount)
                  )
