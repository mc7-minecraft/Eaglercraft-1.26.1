...
public class CommandEncoder {
   ...
   public MappedView mapBuffer(final GpuBuffer buffer, final boolean read, final boolean write) {
      return this.mapBuffer(buffer.slice(), read, write);
   }

   public MappedView mapBuffer(final GpuBufferSlice slice, final boolean read, final boolean write) {
      if (this.backend.isInRenderPass()) {
         throw new IllegalStateException("Close the existing render pass before performing additional commands");
      } else {
