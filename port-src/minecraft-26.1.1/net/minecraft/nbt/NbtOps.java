...
public class NbtOps implements DynamicOps<Tag> {
   ...
   public <U> U convertTo(final DynamicOps<U> outOps, final Tag input) {
      ...
      if (input instanceof EndTag) {
      ...
      } else if (input instanceof ByteTag byteTag) {
         return (U)outOps.createByte(byteTag.value());
      } else if (input instanceof ShortTag shortTag) {
         return (U)outOps.createShort(shortTag.value());
      } else if (input instanceof IntTag intTag) {
         return (U)outOps.createInt(intTag.value());
      } else if (input instanceof LongTag longTag) {
         return (U)outOps.createLong(longTag.value());
      } else if (input instanceof FloatTag floatTag) {
         return (U)outOps.createFloat(floatTag.value());
      } else if (input instanceof DoubleTag doubleTag) {
         return (U)outOps.createDouble(doubleTag.value());
         ...
         return (U)outOps.createString(stringTag.value());
