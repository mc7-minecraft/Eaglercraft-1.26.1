...
public class MacosUtil {
   ...
   public static void exitNativeFullscreen(final com.mojang.blaze3d.platform.Window window) {
      getNsWindow(window)
         .filter(com.mojang.blaze3d.platform.MacosUtil::isInNativeFullscreen)
         .ifPresent(com.mojang.blaze3d.platform.MacosUtil::toggleNativeFullscreen);
   }
   ...
   private static Optional<NSObject> getNsWindow(final com.mojang.blaze3d.platform.Window window) {
