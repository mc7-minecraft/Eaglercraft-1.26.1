...
public final class NativeImage implements AutoCloseable {
   ...
   private final com.mojang.blaze3d.platform.NativeImage.Format format;
   ...
   public NativeImage(final int width, final int height, final boolean zero) {
      this(com.mojang.blaze3d.platform.NativeImage.Format.RGBA, width, height, zero);
   }

   public NativeImage(final com.mojang.blaze3d.platform.NativeImage.Format format, final int width, final int height, final boolean zero) {
      if (width > 0 && height > 0) {
         this.format = format;
         this.width = width;
         this.height = height;
   ...
   public NativeImage(
      final com.mojang.blaze3d.platform.NativeImage.Format format, final int width, final int height, final boolean useStbFree, final long pixels
   ) {
      if (width > 0 && height > 0) {
         this.format = format;
         this.width = width;
   ...
   public static com.mojang.blaze3d.platform.NativeImage read(final InputStream inputStream) throws IOException {
      return read(com.mojang.blaze3d.platform.NativeImage.Format.RGBA, inputStream);
   }

   public static com.mojang.blaze3d.platform.NativeImage read(
      @Nullable final com.mojang.blaze3d.platform.NativeImage.Format format, final InputStream inputStream
   ) throws IOException {
      ByteBuffer file = null;

      com.mojang.blaze3d.platform.NativeImage var3;
      try {
         file = com.mojang.blaze3d.platform.TextureUtil.readResource(inputStream);
   ...
   public static com.mojang.blaze3d.platform.NativeImage read(final ByteBuffer bytes) throws IOException {
      return read(com.mojang.blaze3d.platform.NativeImage.Format.RGBA, bytes);
   }

   public static com.mojang.blaze3d.platform.NativeImage read(final byte[] bytes) throws IOException {
      MemoryStack memoryStack = MemoryStack.stackGet();
      int bytesAvailable = memoryStack.getPointer();
      if (bytesAvailable < bytes.length) {
         ByteBuffer buffer = MemoryUtil.memAlloc(bytes.length);

         com.mojang.blaze3d.platform.NativeImage var13;
         try {
         ...
         com.mojang.blaze3d.platform.NativeImage var5;
         try {
   ...
   private static com.mojang.blaze3d.platform.NativeImage putAndRead(final ByteBuffer nativeBuffer, final byte[] bytes) throws IOException {
      nativeBuffer.put(bytes);
      nativeBuffer.rewind();
      return read(nativeBuffer);
   }

   public static com.mojang.blaze3d.platform.NativeImage read(@Nullable final com.mojang.blaze3d.platform.NativeImage.Format format, final ByteBuffer bytes) throws IOException {
      if (format != null && !format.supportedByStb()) {
         ...
         com.mojang.blaze3d.platform.NativeImage var9;
         try {
            ...
            var9 = new com.mojang.blaze3d.platform.NativeImage(
               format == null ? com.mojang.blaze3d.platform.NativeImage.Format.getStbFormat(comp.get(0)) : format, w.get(0), h.get(0), true, address
            );
         } catch (Throwable var11) {
            if (stack != null) {
               try {
   ...
   public com.mojang.blaze3d.platform.NativeImage.Format format() {
      return this.format;
   }
   ...
   public com.mojang.blaze3d.platform.NativeImage mappedCopy(final IntUnaryOperator function) {
      if (this.format != com.mojang.blaze3d.platform.NativeImage.Format.RGBA) {
         ...
         this.checkAllocated();
         com.mojang.blaze3d.platform.NativeImage result = new com.mojang.blaze3d.platform.NativeImage(this.width, this.height, false);
   ...
   private boolean writeToChannel(final WritableByteChannel output) throws IOException {
      com.mojang.blaze3d.platform.NativeImage.WriteCallback writer = new com.mojang.blaze3d.platform.NativeImage.WriteCallback(output);
   ...
   public void copyFrom(final com.mojang.blaze3d.platform.NativeImage from) {
   ...
   public void copyRect(
      final com.mojang.blaze3d.platform.NativeImage target,
      final int sourceX,
      final int sourceY,
      final int targetX,
      final int targetY,
   ...
   public void resizeSubRectTo(final int sourceX, final int sourceY, final int sizeX, final int sizeY, final com.mojang.blaze3d.platform.NativeImage to) {
      this.checkAllocated();
   ...
   public void untrack() {
      com.mojang.blaze3d.platform.DebugMemoryUntracker.untrack(this.pixels);
   }
   ...
   public com.mojang.blaze3d.platform.Transparency computeTransparency(final int x0, final int y0, final int x1, final int y1) {
      this.checkAllocated();
      if (this.format != com.mojang.blaze3d.platform.NativeImage.Format.RGBA) {
         return com.mojang.blaze3d.platform.Transparency.NONE;
         ...
         if ((long)this.width * (long)this.height * 4L > 2147483647L) {
            ...
            return com.mojang.blaze3d.platform.Transparency.of(hasTransparentPixel, hasTranslucentPixel);
         }
      } else {
         throw new IllegalArgumentException(
   ...
   public com.mojang.blaze3d.platform.Transparency computeTransparency() {
   ...
   public static enum Format {
      ...
      private static com.mojang.blaze3d.platform.NativeImage.Format getStbFormat(final int i) {
         switch (i) {
            case 1:
               return LUMINANCE;
            case 2:
