...
public class CombatTracker {
   ...
   private Component getFallMessage(final CombatEntry knockOffEntry, @Nullable final Entity killingEntity) {
   ...
   @Nullable
   private static Component getDisplayName(@Nullable final Entity entity) {
