...
public class LevelRenderer implements ResourceManagerReloadListener, AutoCloseable {
         ...
         () -> {
            ...
            this.worldBorderRenderer
               .render(
                  ...
                  (double)this.levelRenderState.cameraRenderState.depthFar
               );
         }
      );
   }
   ...
   private void compileSections(final Camera camera) {
      ...
      long fadeDuration = (long)Mth.floor(this.minecraft.options.chunkSectionFadeInTime().get() * 1000.0);
   ...
   private void renderHitOutline(
      ...
      if (SharedConstants.DEBUG_SHAPES) {
         ...
         ShapeRenderer.renderShape(
            poseStack, builder, state.shape(), (double)pos.getX() - camX, (double)pos.getY() - camY, (double)pos.getZ() - camZ, color, width
         );
      }
   }
