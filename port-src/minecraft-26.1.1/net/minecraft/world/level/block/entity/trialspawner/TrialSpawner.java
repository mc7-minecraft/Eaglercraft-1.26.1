...
public final class TrialSpawner {
   ...
   public void applyOminous(final ServerLevel level, final BlockPos spawnerPos) {
      level.setBlock(spawnerPos, level.getBlockState(spawnerPos).setValue(TrialSpawnerBlock.OMINOUS, Boolean.valueOf(true)), 3);
   ...
   public void removeOminous(final ServerLevel level, final BlockPos spawnerPos) {
      level.setBlock(spawnerPos, level.getBlockState(spawnerPos).setValue(TrialSpawnerBlock.OMINOUS, Boolean.valueOf(false)), 3);
