...
public class GpuDevice {
   ...
   private void verifyTextureCreationArgs(@Usage final int usage, final int width, final int height, final int depthOrLayers, final int mipLevels) {
      if (mipLevels < 1) {
   ...
   public GpuBuffer createBuffer(@Nullable final Supplier<String> label, @com.mojang.blaze3d.buffers.GpuBuffer.Usage final int usage, final long size) {
      if (size <= 0L) {
   ...
   public GpuBuffer createBuffer(@Nullable final Supplier<String> label, @com.mojang.blaze3d.buffers.GpuBuffer.Usage final int usage, final ByteBuffer data) {
